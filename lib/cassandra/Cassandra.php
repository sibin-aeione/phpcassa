...
interface CassandraIf {
  public function login(\LegacyCassandra\AuthenticationRequest $auth_request);
  public function set_keyspace($keyspace);
  public function get($key, \LegacyCassandra\ColumnPath $column_path, $consistency_level);
  public function get_slice($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level);
  public function get_count($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level);
  public function multiget_slice($keys, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level);
  public function multiget_count($keys, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level);
  public function get_range_slices(\LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, \LegacyCassandra\KeyRange $range, $consistency_level);
  public function get_paged_slice($column_family, \LegacyCassandra\KeyRange $range, $start_column, $consistency_level);
  public function get_indexed_slices(\LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\IndexClause $index_clause, \LegacyCassandra\SlicePredicate $column_predicate, $consistency_level);
  public function insert($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\Column $column, $consistency_level);
  public function add($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\CounterColumn $column, $consistency_level);
  public function remove($key, \LegacyCassandra\ColumnPath $column_path, $timestamp, $consistency_level);
  public function remove_counter($key, \LegacyCassandra\ColumnPath $path, $consistency_level);
  ...
  public function system_add_column_family(\LegacyCassandra\CfDef $cf_def);
  public function system_drop_column_family($column_family);
  public function system_add_keyspace(\LegacyCassandra\KsDef $ks_def);
  public function system_drop_keyspace($keyspace);
  public function system_update_keyspace(\LegacyCassandra\KsDef $ks_def);
  public function system_update_column_family(\LegacyCassandra\CfDef $cf_def);
...
class CassandraClient implements \LegacyCassandra\CassandraIf {
  ...
  public function send_login(\LegacyCassandra\AuthenticationRequest $auth_request)
  {
    $args = new \LegacyCassandra\Cassandra_login_args();
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_login_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_login_result();
  ...
  {
    $args = new \LegacyCassandra\Cassandra_set_keyspace_args();
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_set_keyspace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_set_keyspace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  public function send_get($key, \LegacyCassandra\ColumnPath $column_path, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_args();
    $args->key = $key;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
  ...
  public function send_get_slice($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_slice_args();
    $args->key = $key;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_slice_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_slice_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_count($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_count_args();
    $args->key = $key;
    $args->column_parent = $column_parent;
    $args->predicate = $predicate;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_count_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_count_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_multiget_slice($keys, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_multiget_slice_args();
    $args->keys = $keys;
    $args->column_parent = $column_parent;
    $args->predicate = $predicate;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_multiget_slice_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_multiget_slice_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_multiget_count($keys, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_multiget_count_args();
    $args->keys = $keys;
    $args->column_parent = $column_parent;
    $args->predicate = $predicate;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_multiget_count_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_multiget_count_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_range_slices(\LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\SlicePredicate $predicate, \LegacyCassandra\KeyRange $range, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_range_slices_args();
    $args->column_parent = $column_parent;
    $args->predicate = $predicate;
    $args->range = $range;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_range_slices_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_range_slices_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_paged_slice($column_family, \LegacyCassandra\KeyRange $range, $start_column, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_paged_slice_args();
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_paged_slice_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_paged_slice_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get_indexed_slices(\LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\IndexClause $index_clause, \LegacyCassandra\SlicePredicate $column_predicate, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_get_indexed_slices_args();
    $args->column_parent = $column_parent;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_get_indexed_slices_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_get_indexed_slices_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_insert($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\Column $column, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_insert_args();
    $args->key = $key;
    $args->column_parent = $column_parent;
    $args->column = $column;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_insert_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_insert_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  public function send_add($key, \LegacyCassandra\ColumnParent $column_parent, \LegacyCassandra\CounterColumn $column, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_add_args();
    $args->key = $key;
    $args->column_parent = $column_parent;
    $args->column = $column;
    $args->consistency_level = $consistency_level;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_add_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  public function send_remove($key, \LegacyCassandra\ColumnPath $column_path, $timestamp, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_remove_args();
    $args->key = $key;
    $args->column_path = $column_path;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_remove_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_remove_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  public function send_remove_counter($key, \LegacyCassandra\ColumnPath $path, $consistency_level)
  {
    $args = new \LegacyCassandra\Cassandra_remove_counter_args();
    $args->key = $key;
    $args->path = $path;
    $args->consistency_level = $consistency_level;
    if ($this->bin_accel)
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_remove_counter_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_remove_counter_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_batch_mutate_args();
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_batch_mutate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_batch_mutate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_atomic_batch_mutate_args();
    $args->mutation_map = $mutation_map;
    $args->consistency_level = $consistency_level;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_atomic_batch_mutate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_atomic_batch_mutate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_truncate_args();
    $args->cfname = $cfname;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_truncate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_truncate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_schema_versions_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_schema_versions_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_schema_versions_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_keyspaces_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_keyspaces_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_keyspaces_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_cluster_name_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_cluster_name_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_cluster_name_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_version_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_version_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_version_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_ring_args();
    $args->keyspace = $keyspace;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_ring_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_ring_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_token_map_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_token_map_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_token_map_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_partitioner_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_partitioner_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_partitioner_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_snitch_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_snitch_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_snitch_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_keyspace_args();
    $args->keyspace = $keyspace;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_keyspace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_keyspace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_splits_args();
    $args->cfName = $cfName;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_splits_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_splits_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_trace_next_query_args();
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_trace_next_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_trace_next_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_describe_splits_ex_args();
    $args->cfName = $cfName;
    $args->start_token = $start_token;
    $args->end_token = $end_token;
    $args->keys_per_split = $keys_per_split;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_describe_splits_ex_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_describe_splits_ex_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_system_add_column_family(\LegacyCassandra\CfDef $cf_def)
  {
    $args = new \LegacyCassandra\Cassandra_system_add_column_family_args();
    $args->cf_def = $cf_def;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_add_column_family_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_add_column_family_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_system_drop_column_family_args();
    $args->column_family = $column_family;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_drop_column_family_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_drop_column_family_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_system_add_keyspace(\LegacyCassandra\KsDef $ks_def)
  {
    $args = new \LegacyCassandra\Cassandra_system_add_keyspace_args();
    $args->ks_def = $ks_def;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_add_keyspace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_add_keyspace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_system_drop_keyspace_args();
    $args->keyspace = $keyspace;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_drop_keyspace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_drop_keyspace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_system_update_keyspace(\LegacyCassandra\KsDef $ks_def)
  {
    $args = new \LegacyCassandra\Cassandra_system_update_keyspace_args();
    $args->ks_def = $ks_def;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_update_keyspace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_update_keyspace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_system_update_column_family(\LegacyCassandra\CfDef $cf_def)
  {
    $args = new \LegacyCassandra\Cassandra_system_update_column_family_args();
    $args->cf_def = $cf_def;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_system_update_column_family_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_system_update_column_family_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_execute_cql_query_args();
    $args->query = $query;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_execute_cql_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_execute_cql_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_execute_cql3_query_args();
    $args->query = $query;
    $args->compression = $compression;
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_execute_cql3_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_execute_cql3_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_prepare_cql_query_args();
    $args->query = $query;
    $args->compression = $compression;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_prepare_cql_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_prepare_cql_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_prepare_cql3_query_args();
    $args->query = $query;
    $args->compression = $compression;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_prepare_cql3_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_prepare_cql3_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_execute_prepared_cql_query_args();
    $args->itemId = $itemId;
    $args->values = $values;
    if ($this->bin_accel)
    {
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_execute_prepared_cql_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_execute_prepared_cql_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_execute_prepared_cql3_query_args();
    $args->itemId = $itemId;
    $args->values = $values;
    $args->consistency = $consistency;
    if ($this->bin_accel)
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_execute_prepared_cql3_query_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_execute_prepared_cql3_query_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \LegacyCassandra\Cassandra_set_cql_version_args();
  ...
  {
    if ($this->bin_accel) $result = thrift_protocol_read_binary($this->input_, '\LegacyCassandra\Cassandra_set_cql_version_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \LegacyCassandra\Cassandra_set_cql_version_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->ire !== null) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'auth_request',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\AuthenticationRequest',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'authnx',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\AuthenticationException',
          ),
        2 => array(
          'var' => 'authzx',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\AuthorizationException',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'ire',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\InvalidRequestException',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'column_path',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\ColumnPath',
          ),
        3 => array(
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\ColumnOrSuperColumn',
          ),
        1 => array(
          'var' => 'ire',
          'type' => TType::STRUCT,
        ...
        2 => array(
          'var' => 'nfe',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\NotFoundException',
          ),
        3 => array(
          'var' => 'ue',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\UnavailableException',
          ),
        4 => array(
          'var' => 'te',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\TimedOutException',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'column_parent',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\ColumnParent',
          ),
        3 => array(
          'var' => 'predicate',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\SlicePredicate',
          ),
        4 => array(
          'var' => 'consistency_level',
          'type' => TType::I32,
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'range',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\KeyRange',
          ),
        4 => array(
          'var' => 'consistency_level',
          'type' => TType::I32,
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\LegacyCassandra\KeySlice',
            ),
          ),
        1 => array(
          'var' => 'ire',
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'index_clause',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\IndexClause',
          ),
        3 => array(
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'column',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\CounterColumn',
          ),
        4 => array(
          'var' => 'consistency_level',
          'type' => TType::I32,
        ...
        1 => array(
          ...
          'val' => array(
            ...
            'val' => array(
              ...
              'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\LegacyCassandra\Mutation',
                ),
              ),
            ),
          ),
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\LegacyCassandra\TokenRange',
            ),
          ),
        1 => array(
          'var' => 'ire',
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'sde',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\SchemaDisagreementException',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\CqlResult',
          ),
        1 => array(
          'var' => 'ire',
          'type' => TType::STRUCT,
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\CqlPreparedResult',
          ),
        1 => array(
          'var' => 'ire',
          'type' => TType::STRUCT,
