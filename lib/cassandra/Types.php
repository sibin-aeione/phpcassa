    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'super_column',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\SuperColumn',
          ),
        3 => array(
          'var' => 'counter_column',
          'type' => TType::STRUCT,
        ...
        4 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\CounterSuperColumn',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'slice_range',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\SliceRange',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\LegacyCassandra\IndexExpression',
            ),
          ),
        2 => array(
          'var' => 'start_key',
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'deletion',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\Deletion',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        5 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\LegacyCassandra\EndpointDetails',
            ),
          ),
        );
    }
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        13 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\LegacyCassandra\ColumnDef',
            ),
          ),
        14 => array(
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          'var' => 'schema',
          'type' => TType::STRUCT,
          'class' => '\LegacyCassandra\CqlMetadata',
          ),
        );
    }
    if (is_array($vals)) {
